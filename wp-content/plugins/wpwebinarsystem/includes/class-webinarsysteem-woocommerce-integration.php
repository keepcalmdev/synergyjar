...
class WebinarSysteemWooCommerceIntegration
{
    ...
    static function add_to_cart_redirect($wc_get_cart_url, $adding_to_cart) {
        ...
        $redirect_to = $settings->get_woocommerce_add_to_cart_redirect_page();

        // redirect to the product page?
        if ($redirect_to === 'product' && $adding_to_cart) {
            return get_permalink($adding_to_cart->get_id());
        }
