	...
	<div id="<?php echo apply_filters('yz_group_template_id', 'yz-bp'); ?>" class="youzer <?php echo yz_groups_directory_class(); ?>">
		...
		<main class="yz-page-main-content">
			...
			<div id="yz-groups-directory">
				...
				<div class="yz-directory-filter directory-filter-bar">
				...
				<?php if (pmpro_hasMembershipLevel('2')) { ?>
					...
					<div class="yz-directory-filter mobile">
						<div class="owner-portal-section owner-owner active"><a href="/community/groups/?filter=ownertoowner&groups_search=topics">Owner to Owner</a></div>
						<div class="owner-portal-section subject-expert"><a href="/community/members/?filter=subjectmatter">Subject Matter Expert Network</a></div>
						<div class="owner-portal-section rate-consultant"><a href="/community/members/?filter=rateconsultant">Consultants Performance Rating</a></div>

					</div>


				<?php
					if ($_REQUEST['filter'] == 'ownertoowner') {
						echo youzer_modal(
							array(
								'modal_title' => 'Owner to Owner Portal',
								'subjectmatter' => '<p>Looking for something specific? Have a question or want to know how a task was managed at a sister agency or another client organization? This secure tool gives you the opportunity to ask questions of other owners. Pick a topic below related to your question and identify your audience to get started. You will have your response shortly. This tool is secure and available to only owners on this site.</p>',
								'modal_name'  => 'ownertoowner',
							)
						);
					}
				} ?>
