...
$nonce = wp_create_nonce("onecommunity_featured_courses_more");
?>

<?php if ($load_more == 'yes') { ?>
<div class="load-more-container">
<span id="load-more-courses" class="show" data-page="1" duration="<?php echo $duration ?>" excerpt="<?php echo $excerpt ?>" data-nonce="<?php echo $nonce; ?>">Load More</span>
</div>
<?php } ?>
...
if ( !wp_verify_nonce( $_REQUEST['nonce'], "onecommunity_featured_courses_more")) {
