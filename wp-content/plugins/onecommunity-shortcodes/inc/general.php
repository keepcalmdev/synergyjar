...
<div class="shortcode-login" id="login-jump">
		...
		<?php echo do_shortcode('[nextend_social_login provider="facebook" login="1" link="1" unlink="1" align="center"]');	?>
		<?php echo do_shortcode('[nextend_social_login provider="linkedin" login="1" link="1" unlink="1" align="center"]');	?>


		<div class="clear"></div>

		<div class="shortcode-login-bottom">
		<a href="<?php echo home_url(); ?>/recovery" class="shortcode-password-recovery"><?php _e( 'Forgot your password?', 'onecommunity-shortcodes' ); ?></a> <a href="<?php echo home_url(); ?>/membership-account/membership-levels/" class="shortcode-login-register"><?php _e("Collaborate Now!", "onecommunity-shortcodes"); ?></a>
		</div>
