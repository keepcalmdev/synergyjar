...
function powerpress_subscribe_shortcode( $attr ) {
	...
	*/
	...
	echo '<script>console.log('.json_encode( $Settings ).');</script>';
...
function powerpress_do_subscribe_widget($settings, $PowerPressSettings)
{
	...
	{
		$html .= '<p class="pp-sub-st">'.  esc_html( $settings['image_url'] ) .'</p>';
	}
	echo '<script>console.log('.json_encode( $settings['image_url'] ).');</script>';	
