			...
			<div class="footer-columns">
				...
				<div class="wrapper">					
					...
					<div class="footer-columns-col-2 footer-column">
						...
						if (has_nav_menu('mini-footer-menu-more')) {

							wp_nav_menu(array(
								'theme_location' => 'mini-footer-menu-more',
								'container' => false,
								'menu_class' => 'mini-footer-menu-more',
								'echo' => true,
								'before' => '',
								'after' => '',
								'link_before' => '',
						...
						<div class="social-icons">
							...
							?>
								...
								<?php
									...
									<a href="https://www.facebook.com/sharer.php?u=<?php global $wp;
																					echo home_url($wp->request); ?>&amp;t=<?php wp_title('|', true, 'right');
																																				bloginfo('name'); ?>"><img class="social" src="<?php echo esc_attr(get_bloginfo('stylesheet_directory', 'display')); ?>/img/icon-facebook.svg" alt="Facebook"></a>
							<?php
								}
							} ?>

<a href=""><img class="social" src="<?php echo esc_attr( get_bloginfo( 'stylesheet_directory', 'display' ) ); ?>/img/linkedin.png" alt="RSS"></a>
