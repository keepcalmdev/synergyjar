...
while (have_posts()) : the_post(); ?>
			...
			<div class="breadcrumbs">
				...
				if (in_array('learnpress-page', $body_classes)) {
					if (learn_press_is_course_tag()) {
						...
						echo esc_attr_e('You are here:', 'onecommunity'); ?> <a href="<?php esc_url($home); ?>"><?php esc_attr_e('Home', 'onecommunity'); ?></a> /
					...
					<?php
						...
						esc_attr_e('You are here:', 'onecommunity'); ?> <a href="<?php esc_url($home); ?>"><?php esc_attr_e('Home', 'onecommunity'); ?></a> /
	...
	endwhile;
		...
		<?php if (in_array('learnpress-page', $body_classes)) { ?>
			<aside id="sidebar">
				<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('sidebar-learnpress')) : ?><?php endif; ?>
			</aside>
			<!--sidebar ends-->
		<?php } else { ?>
			<?php get_sidebar(); ?>
