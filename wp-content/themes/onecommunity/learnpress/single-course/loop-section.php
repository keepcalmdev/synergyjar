...
<li<?php $section->main_class(); ?> id="section-<?php echo esc_html($section->get_slug()); ?>"
                                    data-id="<?php echo esc_html($section->get_slug()); ?>"
                                    data-section-id="<?php echo esc_html($section->get_id()); ?>">
