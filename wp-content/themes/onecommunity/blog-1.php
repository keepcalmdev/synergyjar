...
$wp_query->query('posts_per_page=6'.'&paged=1');
...
<span id="load-more-posts-1" class="show" data-posts-type="1" data-tab-page="1"><?php esc_attr_e('Load More', 'onecommunity'); ?></span>
</div>
