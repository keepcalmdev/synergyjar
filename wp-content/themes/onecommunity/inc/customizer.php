...
$wp_customize->add_setting( 'onecommunity_sidenav_bg',
    array(
    'default' => '#b8f2ed',
    'sanitize_callback' => 'sanitize_hex_color'
));
...
$wp_customize->add_control( 'onecommunity_transient_sidebar_learnpress_expiration', array(
    ...
    'label'    => 'LearPress sidebar cache expiration time in minutes:',
) );
...
$wp_customize->add_control( 'onecommunity_sidebar_profiles_cached_expiration', array(
    ...
    'label'    => 'Buddypress profiles sidebar cache expiration time in minutes:',
) );
