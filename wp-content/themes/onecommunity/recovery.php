...
<main id="content">
	...
	<?php else : ?>
			...
			<div class="login_fields">
				...
				<?php $reset = $_GET['reset']; if($reset == true) { echo '<br /><br /><br /><br /><br /><p style="font-size:18px; color:#d70a00;">' . esc_attr_e('A message will be send to your e-mail address.', 'onecommunity' ) . '</p>'; } ?>
