		...
		<div class="user-top-menu-container">
				<div class="arrow"></div>
					<ul>
						...
						<li><a href="<?php echo bp_loggedin_user_domain(); ?><?php esc_attr_e('notifications', 'onecommunity'); ?>"><?php esc_attr_e('Notifications', 'onecommunity'); ?></a> <?php $count = bp_notifications_get_unread_notification_count( bp_loggedin_user_id() ); if($count > 0) { echo '<span>' . $count . '</span>'; } ?></li>
